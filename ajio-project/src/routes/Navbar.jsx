...
import { BsFillBagCheckFill,BsFillCloudUploadFill } from "react-icons/bs";
...
const Navbar = () => {
  ...
  const { cartLength, setCartLength, setCategory } =
...
{/*             
            {loginValue !== null ? " " :
              <Link to="/admin">
                  <Box display="flex" gap={'2'}  >
                    <BsFillCloudUploadFill style={{ fontSize: "30px" }}/>
                    <Text alignSelf={"end"} as="b" >Admin</Text>
                  </Box>
              </Link>
            }
             */}
